...
QUnit.test( 'update checkbox test', function( assert ) {
    ...
    $( '#departmentsContainer' ).zcrud( 
        ...
        function( options ){
            ...
            testHelper.updateFormVisibleFields( options, [ 'id', 'name', 'important' ] );
...
QUnit.test( 'update radio test', function( assert ) {
    ...
    $( '#departmentsContainer' ).zcrud( 
        ...
        function( options ){
            ...
            testHelper.updateFormVisibleFields( options, [ 'id', 'name', 'phoneType' ] );
...
QUnit.test( 'update select test', function( assert ) {
    ...
    $( '#departmentsContainer' ).zcrud( 
        ...
        function( options ){
            ...
            testHelper.updateFormVisibleFields( options, [ 'id', 'name', 'province' ] );
...
QUnit.test( 'update 2 linked select test', function( assert ) {
    ...
    $( '#departmentsContainer' ).zcrud( 
        ...
        function( options ){
            ...
            testHelper.updateFormVisibleFields( options, [ 'id', 'name', 'province', 'city' ] );
...
QUnit.test( 'update datalist test', function( assert ) {
    ...
    $( '#departmentsContainer' ).zcrud( 
        ...
        function( options ){
            ...
            testHelper.updateFormVisibleFields( options, [ 'id', 'name', 'browser' ] );
...
QUnit.test( 'update checkboxes test', function( assert ) {
    ...
    $( '#departmentsContainer' ).zcrud( 
        ...
        function( options ){
            ...
            testHelper.updateFormVisibleFields( options, [ 'id', 'name', 'hobbies' ] );
