...
export const zcrudServerSide = (function() {
    ...
    var customItemsAjaxBatchUpdate = function( data, dataToSend, filter ){
        ...
        for ( var id in data.existingRecords ) {
            ...
            var newItem = zcrud.utils.extend( true, {}, currentItem, modifiedItem );
        ...
        for ( var c = 0; c < data.newRecords.length; c++ ) {
            ...
            var newItemClone = zcrud.utils.extend( true, {}, people[ id ], newItem );
    ...
    var cloneArray = function( arrayToClone ){
        return zcrud.utils.extend( true, [], arrayToClone );
    };
    ...
    var ajaxBatchUpdate = function( file, data, url, input, subformsData ){
        ...
        for ( var id in data.existingRecords ) {
            ...
            var extendedItem = zcrud.utils.extend( true, {}, currentItem, modifiedItem );
        ...
        for ( var c = 0; c < data.newRecords.length; c++ ) {
            ...
            var newItemClone = zcrud.utils.extend( true, {}, newItem );
            if ( newItem.members ){
                newItem.members = [];
            }
    ...
    var subformFieldBatchUpdate = function( data, current, dataToSend ){
        ...
        for ( var rowId in data.existingRecords ) {
            ...
            zcrud.utils.extend( true, currentItem, modifiedItem );
        }
    ...
    var ajaxGet = function( file, data, input, subformsData, subformsFields ){
        ...
        // Build record
        dataToSend.record = zcrud.utils.extend( true, {}, input[ data.key ] );
        dataToSend.fieldsData = {};
